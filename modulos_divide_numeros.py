...
def div_numeros():
    try:
        ...
        resultado = num1 / num2
        messagebox.showinfo("Resultado", f"O quociente é igual a: {resultado}")
    except ValueError:
...
#Criando os widgets
label_num1 = tk.Label(janela, text="Dividendo:") #Rótulo para o primeiro número
...
label_num2 = tk.Label(janela, text="Divisor:") #Rótulo para o segundo número
...
botao_somar = tk.Button(janela, text="Dividir", command=div_numeros) #Botão para realizar a soma dos números
